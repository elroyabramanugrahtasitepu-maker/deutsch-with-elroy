...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_exam'])) {
    ...
    $total_soal = 0;
    $waktu_terpakai = isset($_POST['waktu_terpakai']) ? (int)$_POST['waktu_terpakai'] : 600;
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .grid-numbers {
            ...
            margin-top: 16px; max-height: 300px; overflow-y: auto; padding-right: 4px;
        }
            ...
            <?php if (!empty($soal_list)): ?>
                <?php foreach($soal_list as $index => $s): 
                    ...
                    if ($q_type === 'pilihan_ganda' || preg_match('/A\)\s*/i', $raw_question)) {
                        ...
                        $clean_q_text = array_shift($parts);
...
<script>
    ...
    function runTimer() {
        ...
        timerInterval = setInterval(() => {
            ...
            waktuInput.value = 600 - timeRemaining;
